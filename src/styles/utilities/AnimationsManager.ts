...
export class AnimationsManager {
	 ...
	 */
	static getAvailableAnimations(): AnimationName[] {
	 ...
	 */
	static addAnimationClass(element: HTMLElement, animationName: AnimationName): void {
	 ...
	 */
	static removeAnimationClass(element: HTMLElement, animationName: AnimationName): void {
